...
using Documenter, BSplineExtension, BSplineExtension.BSplinePlatforms, BSplineExtension.ReductionSolvers
...
makedocs(sitename="BSplineExtension.jl",
    modules = [BSplineExtension,BSplinePlatforms,ReductionSolvers],
    authors = "vincentcp",
    format = format,
    pages = [
        "Home" => "index.md",
